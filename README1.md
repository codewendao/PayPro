...
2. **配置数据库**
   - 创建数据库：`CREATE DATABASE paypro DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
   - 导入数据库脚本：`src/main/resources/db.sql`

3. **修改配置文件**
   - 编辑 `src/main/resources/application.yml`
   - 配置数据库连接、Redis连接、邮箱设置等
...
5. **启动项目**
   ```bash
   java -jar target/paypro-1.0.0.jar
   ```

6. **访问系统**
   - 浏览器打开：`http://localhost:8080`
   - 首页：`http://localhost:8080/home.html`
   - 充值页面：`http://localhost:8080/recharge.html`
...
### 联系我们
- **Email**：support@paypro.com
- **GitHub**：[https://github.com/yourusername/paypro](https://github.com/yourusername/paypro)
- **文档**：[https://paypro-docs.com](https://paypro-docs.com)
